...
install-profile-syswide: sysuser locked_sysuser
	...
	cp -v locked_sysuser.js $(DESTDIR)/$(prefix)/lib/firefox/defaults/pref/channel-prefs.js
	cp -v locked_sysuser.js $(DESTDIR)/$(prefix)/lib/firefox/defaults/pref/vendor-gre.js
